...
router.get("/config/corridor", getCorridorConfig);
router.patch("/config/corridor", requireStaff as any, updateCorridorConfig);
...
router.patch("/:id/status", requireStaff as any, updateJourneyStatus);
